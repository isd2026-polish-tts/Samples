...
| **Sample&nbsp;8**  | Czy rejs żyje jako obiekt kultu. | <audio controls src="original/b_7.wav"></audio> | <audio controls src="output_xtts/b_7.wav"></audio> | <audio controls src="output_f5_tts/b_7.wav"></audio> |
